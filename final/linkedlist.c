    ...
    if(list->type == CONS_TYPE) {
        ...
        while (oldList->type != NULL_TYPE) {
            ...
            switch (car(oldList)->type) {
                ...
                case (CLOSURE_TYPE):
                    carNode->type = CLOSURE_TYPE;
                    carNode->cl = car(oldList)->cl;
                    break;

                case (CONS_TYPE):
                    carNode->type = CONS_TYPE;
                    carNode->c = car(oldList)->c;
                    break;

                case (NULL_TYPE):
                    carNode->type = NULL_TYPE;
                    carNode->c = car(oldList)->c;
                    break;

                case (VOID_TYPE):
                    carNode->type = VOID_TYPE;
                    //carNode->c = car(oldList)->c;
                    break;
                default:
                    break;
